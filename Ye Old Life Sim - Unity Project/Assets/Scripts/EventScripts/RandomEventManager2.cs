...
public class RandomEventManager2 : MonoBehaviour 
{
	...
	public void PlayRandomEvent()
	{
		...
		if (RndEventChance_ <= ValueConstants.RANDOM_EVENT_HAPPENS_AT_LESS_THAN_THIS)
		{
			...
			{
				//Found Shillings
				m_EventDesc = m_EventList[0].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			{
				//Bit By Rats
				m_EventDesc = m_EventList[1].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			{
				//Find a sack
				m_EventDesc = m_EventList[2].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			{
				//Robbed
				m_EventDesc = m_EventList[3].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			{
				//Tournament
				m_EventDesc = m_EventList[4].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			{
				//Weekend Job
				m_EventDesc = m_EventList[5].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			{
				//Kingdom at War
				m_EventDesc = m_EventList[6].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			{
				//Stampede
				m_EventDesc = m_EventList[7].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			else if (D100_ < ValueConstants.MAX_RANDOM_CHANCE_TO_FIND_STARVING_CHILD)
			{
				...
				m_EventDesc = m_EventList[8].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			{
				//The Plague!!
				m_EventDesc = m_EventList[9].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			else if (D100_ < ValueConstants.MAX_RANDOM_CHANCE_FOR_FOOT_AND_MOUTH_DISEASE)
			{
				...
				m_EventDesc = m_EventList[10].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			else if (D100_ < ValueConstants.MAX_RANDOM_CHANCE_FOR_EXPERIMENT_GONE_WRONG)
			{
				...
				m_EventDesc = m_EventList[11].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			else if (D100_ < ValueConstants.MAX_RANDOM_CHANCE_FOR_THE_CIRCUS)
			{
				...
				m_EventDesc = m_EventList[12].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			else if (D100_ <= ValueConstants.MAX_RANDOM_CHANCE_TO_WITNESS_AN_EXECUTION)
			{
				...
				m_EventDesc = m_EventList[13].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			else if (D100_ <= ValueConstants.MAX_RANDOM_CHANCE_TO_WITNESS_A_WITCH_BURNING)
			{
				...
				m_EventDesc = m_EventList[14].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			{
				//Fire
				m_EventDesc = m_EventList[15].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
			...
			else if (D100_ <= ValueConstants.MAX_RANDOM_CHANCE_FOR_BARREL_OF_MEAD)
			{
				...
				m_EventDesc = m_EventList[16].GetComponent<REvntScript>().m_REvent.PlayEvent(m_Player2, m_EventDesc);
